    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-800 flex items-start gap-2">
          ...
          <span>The saved version will appear in your <strong>Document Viewer</strong> under the <strong>Contracts</strong> folder, and in the contract&apos;s version history.</span>
        </div>
